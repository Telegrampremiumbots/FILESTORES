...
#Bot token @Botfather
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "6057842087:AAHU1HL6C8MYXG3VQYtVwhS49CrAFVninYc")
...
#Your db channel Id
CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1001982058140"))
...
#Database 
DB_URI = os.environ.get("DATABASE_URL", "mongodb+srv://periwo4999:sk@cluster0.n6wdyhz.mongodb.net/?retryWrites=true&w=majority")
